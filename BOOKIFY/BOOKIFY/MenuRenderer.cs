...
namespace BOOKIFY
{
    public class MenuRenderer : ToolStripProfessionalRenderer
    {
        ...
        protected override void OnRenderItemText(ToolStripItemTextRenderEventArgs e)
        {
            ...
            e.Item.ForeColor = e.Item.Selected ? Color.FromArgb(20, 73, 72) : textColor; //color when selected
        }
        protected override void OnRenderArrow(ToolStripArrowRenderEventArgs e)
        {
            ...
            var arrowColor = e.Item.Selected ? Color.FromArgb(94,198,196) : primaryColor; // rectangle color when selected
